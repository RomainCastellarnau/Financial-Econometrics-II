...
if __name__ == "__main__":
    ...
    # Question 1
    # - We first compute the PCA model of the returns of the 47 stocks returns.
    ...
    # Question 2
    # - Each stocks returns are regressed on all the selected PC scores using an OLS regression.
    ...
    # Question 4
    # - We can now compute the returns of the first core equity factor and estimate its alpha against the benchmark (SX5E).
    ...
    # Question 5
    # - We are now interested in the impact of the estimation error of the variance covariance matrix on the performance of the core equity factor.
    # - We randomly choose a sample containing 95% of the returns / compute the associated variance covariance matrix.
    # - We then build for each different variance-covariance matrix the core equity factor replicating portfolio and compute the associated alpha.
    # - Having obtained the distribution of the simulated alphas, we can compute the mean and standard deviation of the alphas and build a confidence interval.
    ...
    print("Simulated Alpha Statistics: ", "\n")
